		...
		<div id="caja4">
			<div id="texto1"><br>
				...
				<fieldset style="width: 90%; font-weight: bold;">
					...
					<form action="actualizar_empleado.php" method="post" id="formulario1"
							...
							<div>
								...
								<select name="combo_departamento" id="combo_departamento">
									...
									foreach ($rows2 as $row2) {
										...
										if ($row2['departamento'] == $row['departamento']) {
											echo '<option value="' . $row['departamento'] . '" selected>' . $row['descripcion'] . '</option>';
								...
								<select name="combo_sexo" id="combo_sexo">
									...
									<option value="<?php echo ($sexo); ?>" selected>
										<?php echo ($sexo2); ?>
									</option>
								</select>
								<br />
								<br />
								<input type="hidden" name="txtnumeroOCULTO" id="txtnumeroOCULTO"
