<?php
	...
	// tabla departamentos
    $sql = 'SELECT nombre_empresa, id_factura FROM facturas';
...
<div id="wrapper">
   ...
   <div id="caja2">Programación web
<br>
   Jesus Emmanuel Santos Chavez
   </div>
   ...
   <div id="caja4">
     <div id="texto1"><br>
        <fieldset style="width:90%"    >
            <legend>Facturas Registradas</legend>
          <br />
          <form action="detalle_departamento.php" method="post" id="formulario1">
                <div>
                    <p>
                      <label for="empleado">Id de la Factura:</label>
                    ...
                    <p>
                      <input type="submit" 
                             name="buscarFactura" 
                             value="  Buscar datos de la factura " />
                    </p>
                </div>
            </form>
        </fieldset> 
